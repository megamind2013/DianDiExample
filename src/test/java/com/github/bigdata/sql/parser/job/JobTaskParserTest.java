...
public class JobTaskParserTest {
	public static void main(String[] args) {
		setConfigTest1();
	}
	
	public static void setConfigTest1() {
		String sql = "set flink.test = 'hello world';"
		...
		ArrayList<StatementData> statementDatas = JobTaskHelper.getStatementData(sql);
		System.out.println(statementDatas.size());
		
		StatementData statementData = statementDatas.get(0);
		Statement statement = statementData.getStatement();
		System.out.println(StatementType.SET);
		System.out.println(statementData.getType());
		
		System.out.println(statement.getKey());
		System.out.println(statement.getValue());
		

		statementData = statementDatas.get(1);
	...
	public static void setConfigTest2() {
